...
export default function NavBar() {
  ...
  return (
    <div className='Navbar'>
      <nav className={`pt-4 bg-[#111111] md:text-sm ${state ? "shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-2 md:mt-0" : ""}`}>
          ...
          <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
            ...
            <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
              {user ? (
                <div className="relative">
                  ...
                  {menuOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-10">
                      ...
                      <Link to="/AddVideotest" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded">AddVideotest</Link>
                ...
                <>
                  <Link to="/Login" className="Log-button bg-yellow-400 text-black px-8 py-3 rounded-full font-bold flex items-center gap-2 hover:bg-yellow-300 transition-colors">
                    Log in
                  </Link>
                  <Link to="/Signup" className="sig-button border-2 border-yellow-400 text-yellow-400 px-8 py-3 rounded-full font-bold flex items-center gap-2 hover:bg-yellow-400 hover:text-black transition-colors">
                    Sign in
