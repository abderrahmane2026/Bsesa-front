            ...
            <main className="py-14 mb-5">
                <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                    <div className="max-w-xl space-y-3">
                        ...
                        <p>
                            We're here to help you with any inquiries about our sports programs, training schedules, or other services. Feel free to reach out!
                        </p>
                    </div>
                    <div>
                    ...
                    <form className="items-center space-y-3 sm:justify-center sm:space-x-3 sm:space-y-0 sm:flex lg:justify-start">
                        <Link to="/Contact">
                            <button className="outline-none bg-indigo-600 text-white text-center px-4 py-3 rounded-md shadow w-full ring-offset-2 ring-indigo-700 focus:ring-2 sm:w-auto">
                                Contact Us
                            </button>
                        </Link>
                    </form>
